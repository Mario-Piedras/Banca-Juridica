...
@Component({
  selector: 'app-solicitar-producto2',
  standalone: true,
  imports: [CommonModule, FormsModule, ConfirmModalComponent],
  templateUrl: './solicitar-producto2.component.html',
  styleUrl: '../solicitar-producto/solicitar-producto.component.css'
})
export class SolicitarProducto2Component implements OnInit {
  ...
  private limpiarFormulario(): void {
    ...
    const fileInput = document.getElementById('archivoInputSolicitudProducto2') as HTMLInputElement | null;
